    ...
    <div className="flex flex-col items-center">
      <div className="relative">
        ...
        <Button
          variant="ghost"
          size="icon"
          className="absolute top-1/2 -left-12 transform -translate-y-1/2 -translate-x-full"
          onClick={prevSlide}
        >
        ...
        <Button
          variant="ghost"
          size="icon"
          className="absolute top-1/2 -right-12 transform -translate-y-1/2 translate-x-full"
          onClick={nextSlide}
        >
