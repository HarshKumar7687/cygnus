    ...
    <div className="flex min-h-screen bg-gradient-to-r from-blue-100 to-purple-200 dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="flex flex-col justify-center w-full p-8 lg:w-1/2">
        <div className="max-w-md mx-auto">
          <h1 className="mb-4 text-4xl font-bold">Welcome to Cygnus</h1>
          <p className="mb-8 text-gray-600 dark:text-gray-100">
            Connect beyond words — understand every voice, every emotion.
          </p>
          ...
          <div className="flex flex-col space-y-4 mt-6">
            <div className="relative w-full">
                <div className="absolute inset-0 flex items-center">
                    <span className="w-full border-t border-gray-400 dark:border-gray-300" ></span>
                </div>
            ...
            <p className="text-sm text-center text-gray-600 dark:text-gray-400">
                Dont have an account? {" "}
                 <Link href="#" className="text-blue-500 hover:underline dark:text-blue-400">Create now!</Link>
            </p>
          </div>
        </div>
      </div>
